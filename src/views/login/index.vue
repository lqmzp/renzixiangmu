<template>
  <div class="login-container">
    <el-form ref="loginFrom" class="login-form" auto-complete="on" label-position="left" :rules="rules" :model="loginFrom">
      ...
      <el-form-item prop="password">
        ...
        <el-input ref="pwd" v-model="loginFrom.password" :type="passwordType" placeholder="请输入密码" />
      ...
      <div class="tips">
        <span style="margin-right:20px;">账号: 13800000002</span><span> 密码: 123456</span>
      </div>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        password: [
          { required: true, message: '密码码必填', trigger: 'blur' },
